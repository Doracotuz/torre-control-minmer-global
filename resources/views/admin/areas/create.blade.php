                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4" class="block mt-1 w-full border-gray-300 focus:border-[#ff9c00] focus:ring-[#ff9c00] rounded-md shadow-sm">{{ old('description') }}</textarea>
                            ...
                            <div class="border-t border-gray-200 pt-4 mt-4">
                                ...
                                <div class="mb-4">
                                    <label for="is_client" class="inline-flex items-center">
                                        <input id="is_client" type="checkbox" class="rounded border-gray-300 text-[#ff9c00] shadow-sm focus:ring-[#ff9c00]" name="is_client" value="1" {{ old('is_client') ? 'checked' : '' }}>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="storage_rate" class="block mt-1 w-full" type="number" step="0.01" name="storage_rate" :value="old('storage_rate', 15.00)" placeholder="15.00" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="emitter_name" class="block mt-1 w-full" type="text" name="emitter_name" :value="old('emitter_name')" />
                                    <x-input-error :messages="$errors->get('emitter_name')" class="mt-2" />
                                </div>

                                <div class="mt-4">
                                    <x-input-label for="emitter_phone" :value="__('Teléfono')" />
                                    <x-text-input id="emitter_phone" class="block mt-1 w-full" type="text" name="emitter_phone" :value="old('emitter_phone')" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="emitter_address" class="block mt-1 w-full" type="text" name="emitter_address" :value="old('emitter_address')" />
                                ...
                                <div class="grid grid-cols-2 gap-4 mt-4">
                                    <div>
                                        ...
                                        <x-text-input id="emitter_colonia" class="block mt-1 w-full" type="text" name="emitter_colonia" :value="old('emitter_colonia')" />
                                        <x-input-error :messages="$errors->get('emitter_colonia')" class="mt-2" />
                                    </div>
                                    <div>
                                        <x-input-label for="emitter_cp" :value="__('C.P.')" />
                                        <x-text-input id="emitter_cp" class="block mt-1 w-full" type="text" name="emitter_cp" :value="old('emitter_cp')" />
