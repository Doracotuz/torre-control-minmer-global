            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border border-gray-200 p-6 md:p-8">
                ...
                <form method="POST" action="{{ route('admin.roles.update', $role) }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" id="name" required class="mt-1 block w-full border-gray-300 focus:border-[#ff9c00] focus:ring-[#ff9c00] rounded-md shadow-sm" value="{{ old('name', $role->name) }}" placeholder="Ej: Jefe de Almacén">
