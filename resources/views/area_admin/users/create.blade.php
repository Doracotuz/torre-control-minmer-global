<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Crear Nuevo Usuario en el Área: ') }} {{ $currentArea->name }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('area_admin.users.store') }}">
                        @csrf
                        ...
                        <!-- Área (solo lectura, ya que se asigna automáticamente) -->
                        <div class="mt-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Este usuario se asignará automáticamente a tu área.</p>
                        </div>
