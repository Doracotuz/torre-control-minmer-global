...
<div class="w-full max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-4xl font-bold text-[var(--color-text-primary)] tracking-tight">Editar Categoría</h1>
        <p class="text-[var(--color-text-secondary)] mt-1">Modifica el nombre de la categoría existente.</p>
    </div>
    ...
    <div class="bg-white p-8 rounded-xl shadow-lg mt-8">
        <form action="{{ route('asset-management.categories.update', $category) }}" method="POST">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" class="form-input w-full" value="{{ old('name', $category->name) }}" required autofocus>
            </div>
