...
<div class="w-full max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-4xl font-bold text-[var(--color-text-primary)] tracking-tight">Añadir Nuevo Modelo</h1>
        <p class="text-[var(--color-text-secondary)] mt-1">Completa los detalles del nuevo modelo de hardware.</p>
    </div>
        ...
        <form action="{{ route('asset-management.models.store') }}" method="POST">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" id="name" name="name" class="form-input w-full" placeholder="Ej: MacBook Pro 16, Latitude 5420" required autofocus>
                </div>
                <div>
