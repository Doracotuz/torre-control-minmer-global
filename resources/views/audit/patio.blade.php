            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="file" name="foto_unidad" x-ref="fotoUnidadInput" @change="previewFile($event, 'fotoUnidadPreview')" class="hidden" accept="image/*">
                    ...
                    <div>
                        ...
                        <input type="file" name="foto_llantas" x-ref="fotoLlantasInput" @change="previewFile($event, 'fotoLlantasPreview')" class="hidden" accept="image/*">
