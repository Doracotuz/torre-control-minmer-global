    ...
    <div class="py-6 sm:py-12 bg-[#E8ECF7]" x-data="fileManager()">
        ...
        <div x-show="showMediaModal"
            ...
            <div class="bg-white rounded-lg shadow-2xl w-full max-w-4xl max-h-[95vh] overflow-hidden flex flex-col relative"
                :class="fullscreen && mediaModalData.type === 'pdf' ? '!max-w-none !max-h-none !h-[100vh] !min-h-[100vh] !w-[100vw] !min-w-[100vw] !m-0 fixed inset-0 z-50 overflow-hidden transform scale-[1.25] origin-top-left' : ''"
                @click.stop>
                ...
                <div class="p-6 overflow-y-auto flex-1 flex flex-col items-center justify-center"
                    :class="fullscreen && mediaModalData.type === 'pdf' ? '!p-0 !h-[100vh] !min-h-[100vh]' : ''">
                    <div class="w-full flex-1 flex items-center justify-center">
                        ...
                        <template x-if="mediaModalData.type === 'pdf'">
                            <iframe :src="mediaModalData.url" 
                                    ...
                                    :class="fullscreen ? '!h-[100vh] !min-h-[100vh] !w-[100vw] !min-w-[100vw] !border-0 !rounded-none' : 'h-[70vh]'"></iframe>
                        </template>
