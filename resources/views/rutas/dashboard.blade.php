    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="bg-white p-6 rounded-lg shadow-md col-span-1"><canvas id="chart1"></canvas></div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md col-span-1"><canvas id="chart4"></canvas></div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md lg:col-span-3"><canvas id="chart7"></canvas></div>
            </div>
        </div>
    </div>
