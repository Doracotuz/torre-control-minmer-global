        ...
        <div class="max-w-4xl mx-auto px-6 pt-10 relative z-10">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <h1 class="text-4xl font-raleway font-black text-[#2c3856]">Nueva Marca</h1>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] shadow-soft border border-gray-100 p-8 md:p-12">
                <form action="{{ route('wms.brands.store') }}" method="POST">
                    ...
                    <div class="mt-12 flex justify-end items-center gap-4">
                        ...
                        <button type="submit" class="px-10 py-3 rounded-xl bg-[#2c3856] text-white font-bold shadow-lg shadow-[#2c3856]/30 hover:bg-[#1a253a] hover:-translate-y-0.5 transition-all">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
