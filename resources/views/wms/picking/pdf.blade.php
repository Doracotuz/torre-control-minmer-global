...
<head>
    ...
    <style>
        ...
        .quality-cell { font-size: 8pt; color: #17a2b8; }
        .sku-cell { font-size: 8pt; color: #6c757d; }
        .product-name { font-size: 9pt; }
        .pedimento-cell { font-size: 8pt; }
        .quantity-cell { font-size: 14pt; }
        .check-cell { font-size: 16pt; }
        ...
        #footer { position: fixed; bottom: -50px; left: 0px; right: 0px; height: 50px; text-align: center; font-size: 8pt; color: #777; border-top: 1px solid #eee; padding-top: 10px; }
    </style>
</head>
<body>
