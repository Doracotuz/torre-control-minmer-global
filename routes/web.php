...
Route::middleware(['auth', 'module.access:files'])->group(function () {
    ...
    Route::get('/indicadores/{folder}', [IndicadoresController::class, 'show'])->name('indicadores.show');
...
Route::middleware(['auth', 'module.access:client_dashboard'])->group(function () {
...
Route::middleware(['auth', 'module.access:organigram'])->group(function () {
...
Route::middleware(['auth', 'module.access:rfq'])->group(function () {
    Route::get('/rfq', [RfqController::class, 'index'])->name('rfq.index');
});

Route::middleware(['auth', 'module.access:tracking'])->group(function () {
...
Route::middleware(['auth'])->prefix('admin/organigram')->name('admin.organigram.')->group(function () {
...
Route::middleware(['auth', 'check.area:area_admin', 'module.access:area_admin'])->prefix('area-admin')->name('area_admin.')->group(function () {
    Route::get('/dashboard', function () {
        return view('area_admin.dashboard');
    })->name('dashboard');
...
Route::middleware(['auth', 'check.area:area_admin', 'module.access:routes'])->prefix('rutas')->name('rutas.')->group(function () {
...
Route::middleware(['auth', 'not_client', 'module.access:tickets'])->group(function () {
...
Route::middleware(['auth', 'check.area:Customer Service,Administración,Tráfico', 'module.access:customer_service'])->prefix('customer-service')->name('customer-service.')->group(function () {
...
Route::middleware(['auth', 'module.access:projects'])->prefix('projects')->name('projects.')->group(function () {
...
Route::middleware(['auth', 'module.access:wms'])->prefix('wms')->name('wms.')->group(function () {
...
Route::middleware(['auth', 'ff.access', 'module.access:orders'])->prefix('ff')->name('ff.')->group(function () {
    ...
    Route::get('/orders/{folio}/report', [FfOrderController::class, 'downloadReport'])->name('orders.downloadReport');
